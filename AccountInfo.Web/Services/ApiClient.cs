...
public class ApiClient
{
    ...
    public Task<List<InternetAccountDto>?> GetInternetAccountsByLocationAsync(int locationId)
    => _httpClient.GetFromJsonAsync<List<InternetAccountDto>>($"/api/internetaccounts/bylocation/{locationId}");
    ...
    public Task<List<PhoneAccountDto>?> GetPhoneAccountsByLocationAsync(int locationId)
        => _httpClient.GetFromJsonAsync<List<PhoneAccountDto>>($"/api/phoneaccounts/bylocation/{locationId}");
